...
术语表；与 prd-spec §2 对应。`schemas/spec.py` 中 `GlossaryEntry` 建模；经 `context.glossary[]` 传递，**SPEC-118** 校验条目非空。
...
|------|------|-------------------|
| `context.glossary[]` | ✓ 约定 | `GlossaryEntry`；`context.glossary[]` 透传；**SPEC-118** |
