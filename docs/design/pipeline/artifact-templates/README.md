...
| **校验规则** | [quality-gates/](../quality-gates/README.md) | `spec_validate` / `design_validate` |
...
|------|-------------------|-------------------|------|
| [prd-spec.md](./prd-spec.md) | [artifact-schemas/prd-spec.md](../artifact-schemas/prd-spec.md) · `spec.json` | PM（`pm`） | FEAT / US / REQ / AC；§9 非功能性需求 |
...
| [dev-principles-spec.md](./dev-principles-spec.md) | —（约束 `code_root`） | Developer（`developer`） | README、SRP、测试纪律；注入 `dev-principles-snippet.txt` |
