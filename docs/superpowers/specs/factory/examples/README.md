...
> **字段规格（真源）：** [../artifacts/schemas/](../artifacts/schemas/README.md)  
> **人读模板与长样例：** [../artifacts/format-to-human/](../artifacts/format-to-human/README.md)  
> **主线：** [multi-agent-pipeline-design.md](../../multi-agent-pipeline-design.md) §5 索引

本目录存放 **可拷贝的示例片段**；完整嵌套类型与校验规则以 `artifacts/schemas/` 为准。
...
单次 run 的完整产物路径：`docs/factory/runs/<task_id>/`（见主线 §6.1）。
