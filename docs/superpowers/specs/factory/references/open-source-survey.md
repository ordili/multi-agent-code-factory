...
| 扩展 | Schema / 配置 | 阶段 |
|------|----------------|------|
| `DevManifest.reflection` | [dev-manifest.md](../artifacts/schemas/dev-manifest.md) | P0 |
| `Profile.toolchain` + `test_parsers/` | [profiles.md](../profiles.md)、[test-report.md](../artifacts/schemas/test-report.md) | P0 |
